...
export const CustomHeader = () => {
    ...
    const handleSearch = (event: KeyboardEvent<HTMLInputElement>) => {
        ...
        if (!query) {
            newSearchParmas.delete('query');
        } else {
            newSearchParmas.set('query', inputRef.current!.value);
        }
